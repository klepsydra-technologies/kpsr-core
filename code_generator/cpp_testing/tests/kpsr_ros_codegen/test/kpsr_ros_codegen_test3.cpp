...
#include "composition_type_ros_mapper.h"
...
TEST(KpsrRosCodegeTest, compositionTypeMapperTest)
{
    ...
    fromRosProvider
        .registerToTopic<kpsr::codegen::CompositionType, kpsr_ros_codegen::CompositionType>(
    ...
    ros::Publisher stringPublisher =
        nodeHandle.advertise<kpsr_ros_codegen::CompositionType>("kpsr_ros_codegen_test_topic1",
                                                                10,
                                                                true);
    ...
    kpsr::Publisher<kpsr::codegen::CompositionType> *kpsrPublisher =
        toRosProvider.getToMiddlewareChannel<kpsr::codegen::CompositionType,
                                             kpsr_ros_codegen::CompositionType>(
