...
public:
     ...
     */
    CoreContainer(Environment *env, const std::string &applicationName);
     ...
     * @param publicationStats Pointer to a publication stats.
     */
    void detach(PublicationStats *publicationStats);
    ...
    kpsr::Environment *getEnvironment() const override;
