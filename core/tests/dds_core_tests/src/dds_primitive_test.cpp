...
protected:
    DDSCoreTest()
        ...
        , provider(nullptr)
        , primitivePublisherService(
              provider.getToMiddlewareChannel<GreetEnum, kpsr_dds_serialization::LongData>(
                  "enumData", 0, nullptr, &enumDataWriter),
              ...
              provider.getToMiddlewareChannel<int, kpsr_dds_serialization::LongData>("longData",
                                                                                     ...
                                                                                     nullptr,
                                                                                     &longDataWriter),
              provider.getToMiddlewareChannel<bool, kpsr_dds_serialization::BoolData>(
                  "boolData", 0, nullptr, &boolDataWriter),
              provider.getToMiddlewareChannel<double, kpsr_dds_serialization::DoubleData>(
                  "doubleData", 0, nullptr, &doubleDataWriter),
              provider.getToMiddlewareChannel<float, kpsr_dds_serialization::FloatData>(
                  "floatData", 0, nullptr, &floatDataWriter),
    ...
    void SetUp() override
    {
        ddsProvider.registerToTopic("enumData",
                                    &enumDataReader,
                                    true,
                                    enumDataSafeQueueProvider.getPublisher());
        ddsProvider.registerToTopic("octetData",
                                    &octetDataReader,
                                    true,
                                    octetDataSafeQueueProvider.getPublisher());
        ddsProvider.registerToTopic("longData",
                                    &longDataReader,
                                    true,
                                    longDataSafeQueueProvider.getPublisher());
        ddsProvider.registerToTopic("boolData",
                                    &boolDataReader,
                                    true,
                                    boolDataSafeQueueProvider.getPublisher());
        ddsProvider.registerToTopic("doubleData",
                                    &doubleDataReader,
                                    true,
                                    doubleDataSafeQueueProvider.getPublisher());
        ddsProvider.registerToTopic("floatData",
                                    &floatDataReader,
                                    true,
                                    floatDataSafeQueueProvider.getPublisher());
        ddsProvider.registerToTopic("stringData",
                                    &stringDataReader,
                                    true,
                                    stringDataSafeQueueProvider.getPublisher());
    }
...
TEST_F(DDSCoreTest, PubSubTest)
{
    ...
    for (int i = 0; i < NUM_TESTS; i++) {
        ...
        ASSERT_GT(attempts, 0) << i;
        ASSERT_FLOAT_EQ((primitivePublisherService._seq * 10.0),
