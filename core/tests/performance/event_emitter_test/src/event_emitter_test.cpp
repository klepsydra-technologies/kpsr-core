...
public:
    ...
    {
        int laserData = 50;
        kpsr::EventEmitterMiddlewareProvider<kpsr::sensors::LaserScanEvent> provider(nullptr,
                                                                                     "event",
                                                                                     0,
                                                                                     nullptr,
                                                                                     nullptr);
        kpsr::EventEmitterMiddlewareProvider<Point3dCloud> newProvider(nullptr,
                                                                       "newEvent",
                                                                       0,
                                                                       nullptr,
                                                                       nullptr);
...
int main(int argc, char **argv)
{
    ...
    spdlog::info("total cacheListener time: {} / {}",
                 totalCacheListenerTimesResult.average,
                 totalCacheListenerTimesResult.stddev);
}
